            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NormaFuelId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Linear = table.Column<int>(nullable: false),
                    Summer = table.Column<int>(nullable: false),
                    Winter = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);//!!! каскадное удаление
                });
